...
6. Under General section, click {{<guilabel name="ADD APP">}} and select `iOS`.

7. Enter your iOS Bundle ID (You can find that by going to {{<menu menu1="Config" menu2="iOS App Settings">}} ). Then, click {{<guilabel name="REGISTER APP">}}.
...
In this page, we only describe some main APIs used in our [Demo](https://monaca.mobi/directimport?pid=5ac5776ee788854f3a8b456a). For a complete API references, please refer to [here](https://github.com/danwilson/google-analytics-plugin).
